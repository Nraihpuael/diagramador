                    ...
                    <div class="col-13 col-md-auto ms-auto">
                        <div class="row g-2 align-items-center" >
                            ...
                            <div class="col-auto ">
                                ...
                                <div class="col-auto">
                                    <a href="{{ route('diagramas.script', $diagrama->id) }}" class="btn btn-white"
                                        title="Script">
                                        Script
                                    </a>
                                </div>
                                <div class="col-auto">
                                    <a href="{{ route('diagramas.crud', $diagrama->id) }}" class="btn btn-white"
                                        title="CRUD">
                                        CRUD
                                    </a>
                                </div>    
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            Seguir la Sintaxis nombre_de_atributo tipo_atributo<br>
                            Si quiere definir llave primaria luego del tipo_atributo escriba PK<br>
                            Si es llave Foranea escriba FK
                        </h5>
